...
//        }
//    }
//    @PostMapping("/ajouterAvecDepenses")
//    public ResponseEntity<ProjetDto> ajouterProjetAvecDepenses(@RequestBody ProjetDto projetDto, @RequestBody List<DepenseDto> depensesDto) {
//        try {
//            ProjetDto projetAjoute = projetService.ajouterProjetAvecDepenses(projetDto, depensesDto);
//            return ResponseEntity.ok().body(projetAjoute);
//        } catch (Exception e) {
